...
bool test_shunting_yard(bool debug=false){
  ...
  // cout << "created token with type " << infix2.back() -> get_type() << endl;
  ...
  std::cout << "Token types in infix2 before calling sy.postfix:" << std::endl;
  ...
  ShuntingYard sy2;
  std::cout << "Token types in infix2 before calling sy2.postfix:" << std::endl;
  for (Queue<Token*>::Iterator it = infix2.begin(); it != infix2.end(); ++it) {
    std::cout << (*it)->get_type() << " ";
  }
  std::cout << std::endl;
  postfix = sy2.postfix(infix2);
  std::cout << "Token types in infix2 after calling sy2.postfix:" << std::endl;
  for (Queue<Token*>::Iterator it = infix2.begin(); it != infix2.end(); ++it) {
    std::cout << (*it)->get_type() << " ";
  }
  std::cout << std::endl;
